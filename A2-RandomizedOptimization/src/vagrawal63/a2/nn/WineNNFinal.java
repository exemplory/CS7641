...
public class WineNNFinal {
	...
	public static void main(String[] args) {
		...
		oa[1] = new SimulatedAnnealing(1e9, 0.85, nnop[1]);
		oa[2] = new StandardGeneticAlgorithm(250, 150, 10, nnop[2]);

		// int[] epochs = { 20, 100, 500, 1000, 2500, 5000, 10000};
		int[] epochs = { 10000 };
		String fileName1 = "WineNN_Train.csv";
		String fileName2 = "WineNN_Test.csv";
		String dir = "Optimization";
		FileOperationsHelper.writeToFile(fileName1, dir, FileOperationsHelper.getNNTrainFileHeader(), false);
		FileOperationsHelper.writeToFile(fileName2, dir, FileOperationsHelper.getNNTestFileHeader(), false);
		...
		for (int epoch : epochs) {
			...
			for (int i = 0; i < oa.length; i++) {
				...
				testingTime /= 1000;
				results = "";
				results = oaNames[i] + "," + epoch + "," + df.format(correct / (correct + incorrect)) + ","
